...
<i class="fa fa-wrench" style="font-size:13px"> <br><br>➤Program connectst to the database using the credentials provided inside config file and database name provided to the terminal.</i>
...
<i class="fa fa-wrench" style="font-size:13px"><br> ➤Program looks for the tables named as <i>"STUDENTS"</i> and <i>"INTERESTS"</i>:</i>
...
<i class="fa fa-wrench" style="font-size:13px"> 
<br>➤Program prints the tables named as  <i>"STUDENTS"</i> and <i>"INTERESTS"</i>. <i>The program uses a seperate class which dynamically prints the tables. It is not staticly programmed to print the specific tables.</i></i>
...
<i class="fa fa-wrench" style="font-size:13px"> <br>➤Program asks for the specific action to take:</i>
